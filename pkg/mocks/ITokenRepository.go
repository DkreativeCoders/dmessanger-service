...
func (_m *ITokenRepository) FindByOtp(otp string) (*domain.Token, error) {
	ret := _m.Called(otp)
...
// UpdateToken provides a mock function with given fields: tk
func (_m *ITokenRepository) UpdateToken(tk domain.Token) (*domain.Token, error) {
	ret := _m.Called(tk)
